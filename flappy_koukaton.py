...
class Bird(pg.sprite.Sprite):
    ...
    def change_img(self, num: int, screen: pg.Surface):
        ...
        引数2 screen:画面Surface
        """
        self.img = pg.transform.rotozoom(pg.image.load(f"ex05/fig/{num}.png"), 0, 2.5)
...
class GoodItem(pg.sprite.Sprite):
    ...
    def __init__(self, xy: tuple[int, int]):
        super().__init__()
        self.image = pg.transform.rotozoom(pg.image.load(f"ex05/fig/good_item.png"), 0, 0.05)
        self.rect = self.image.get_rect()
        self.rect.center = xy
        self.tmr = 0
...
class BadItem(pg.sprite.Sprite):
    ...
    def __init__(self, xy: tuple[int, int]):
        super().__init__()
        self.image = pg.transform.rotozoom(pg.image.load(f"ex05/fig/bad_item.png"), 0, 0.05)
        self.rect = self.image.get_rect()
        self.rect.center = xy
        self.tmr = 0
...
def main():
    ...
    # gameover画像
    gameover_img = pg.transform.rotozoom(pg.image.load("ex05/fig/gameover.png"), 0, 0.3)
